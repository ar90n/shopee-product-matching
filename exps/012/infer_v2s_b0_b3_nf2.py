    ...
    return {
        ...
        "model_params": [
            (
                ...
                {"name": "arcface", "num_classes": TrainData.label_group_unique_count_pdf_fold},
                {"name": "cosine", "threshold": 0.32},
            ),
            (
                "efficientnet_b3",
                "exp-005-effb3/exp-005-fold1-epoch7-val_loss0.00.ckpt",
                {"name": "arcface", "num_classes": TrainData.label_group_unique_unique_count},
                {"name": "cosine", "threshold": 0.32},
            ),
            (
                "efficientnet_b0",
