...
def get_config_defaults() -> Dict[str, Any]:
    return {
        ...
        "model_params": [
            (
                "nf_regnet_b1",
                "exp-011-nf_regnet_b1/exp-011-fold0-epoch5-val_loss0.00.ckpt",
                "arcface",
                {"name": "cosine", "threshold": 0.45},
            ),
            (
                "nf_regnet_b1",
                "exp-011-nf_regnet_b1/exp-011-fold1-epoch6-val_loss0.00.ckpt",
                "arcface",
                {"name": "cosine", "threshold": 0.45},
            ),
            (
                "nf_regnet_b1",
                "exp-011-nf_regnet_b1/exp-011-fold2-epoch6-val_loss0.00.ckpt",
                "arcface",
                {"name": "cosine", "threshold": 0.45},
            ),
        ],
