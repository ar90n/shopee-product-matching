...
def get_config_defaults() -> Dict[str, Any]:
    return {
        ...
        "checkpoint_filenames": [
            "exp-011-effv2s/exp-011-fold0-epoch4-val_loss0.00.ckpt",
            "exp-011-effv2s/exp-011-fold1-epoch4-val_loss0.00.ckpt",
            "exp-011-effv2s/exp-011-fold2-epoch4-val_loss0.00.ckpt",
            "exp-011-effv2s/exp-011-fold3-epoch4-val_loss0.00.ckpt",
            "exp-011-effv2s/exp-011-fold4-epoch4-val_loss0.00.ckpt",
        ],
    }
